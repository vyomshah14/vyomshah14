...
I am an ambitious software developer pursuing a B.Tech in Computer Science and Engineering. I focus on building practical, problem-solving applications using **JavaScript/TypeScript**, **React**, **Java**, **Python**, **SQL**, and **C++**, with a strong interest in **AI integrations**, **web development**, **data structures & algorithms (DSA)**, and **basic cybersecurity**.
...
![Cybersecurity](https://img.shields.io/badge/cybersecurity-%23FF0000.svg?style=flat-square&logo=target&logoColor=white)
